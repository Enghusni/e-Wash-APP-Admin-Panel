...
export const DashboardMenu = [
  ...
  { id: uuid(), link: "/appointments", icon: "layout", title: "Appointments" },
  { id: uuid(), link: "/customers", icon: "user", title: "Customers" },
  { id: uuid(), link: "/service-type", icon: "layout", title: "Services Type" },
  { id: uuid(), link: "/car-type", icon: "layout", title: "Car Type" },
  { id: uuid(), link: "/services", icon: "layout", title: "Services" },
  { id: uuid(), link: "/employees", icon: "user-check", title: "Employees" },
  { id: uuid(), link: "/reports", icon: "layout", title: "Reports" },
  { id: uuid(), link: "/promotions", icon: "layout", title: "Promotions" },
  { id: uuid(), link: "/settings", icon: "layout", title: "Settings" },
  { id: uuid(), link: "/supports", icon: "layout", title: "Supports" },
