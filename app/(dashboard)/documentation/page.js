        ...
        <Col lg={12} md={12} sm={12}>
          <div className="border-bottom pb-4 mb-4 d-md-flex justify-content-between align-items-center">
            <div className="mb-3 mb-md-0">
              <h1 className="mb-0 h2 fw-bold">E Wash NextJS</h1>
              <p className="mb-0">
                Welcome to the E Wash NextJS version of the original E Wash
                theme.
              </p>
            </div>
          </div>
        ...
        <Col lg={7} md={12} sm={12}>
          <Card>
            <Card.Body>
              ...
              <p className="lead">
                A professional E Wash NextJS Kit that comes with plenty of
                ready-to-use components that will help you to build more
                beautiful application (web app).
              </p>

              <p>
                E Wash Kit is built with the most popular front-end framework{" "}
                <a
              ...
              <p>
                This doc will guide you to understand how E Wash-NextJS theme is
              ...
              <ol>
                ...
                <li>
                  {" "}
                  <h4 className="mb-0 fw-bold">Install E Wash NextJS</h4>
                  <p>
